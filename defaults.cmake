...
function(find_freetype)
  if(${MSVC})
    ...
    check_link_directory_msvc("freetype-" "objs/vc2010/Win32")
    set(FREETYPE_LIBRARY_DEBUG "freetype255d.lib" PARENT_SCOPE)
    set(FREETYPE_LIBRARY "freetype255.lib" PARENT_SCOPE)
  else()
    set(lib_mode SHARED)
    if(1 LESS ${ARGC})
      set(lib_mode "${ARGV1}")
...
function(find_png)
  if(${MSVC})
    ...
    check_link_directory_msvc("lpng" "projects/vstudio")
